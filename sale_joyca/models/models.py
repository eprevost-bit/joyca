...
class SaleOrder(models.Model):
    ...
    def action_create_new_version(self):
        ...
        # Forzamos que los cambios se guarden en la base de datos antes de continuar.
        # Esto evita problemas de concurrencia o de que el estado no se guarde a tiempo.
